    ...
    <div class="health-model">
      <div class="repository">
        <div class="rep-container">
          ...
          <h1>{{ repository1.owner }}/{{ repository1.name }}</h1>
          ...
          <div class="info-grid">
            <div class="info-item">
              ...
              <div>{{ repository1.forks_count.toLocaleString() }}</div>
            </div>

            <div class="info-item">
              <div class="stat-name">Forks:</div>
              <div>{{ repository1.forks.toLocaleString() }}</div>
            </div>

            <div class="info-item">
              <div class="stat-name">Watchers:</div>
              <div>{{ repository1.watchers_count.toLocaleString() }}</div>
            </div>

            <div class="info-item">
              <div class="stat-name">Issues:</div>
              <div>{{ repository1.open_issues_count.toLocaleString() }}</div>
            </div>

            <div class="info-item">
              <div class="stat-name">Tags:</div>
              <div>{{ (repository1.topics || []).join(", ") }}</div>
            </div>

            <div class="info-item">
              <div class="stat-name">Default Branch:</div>
              <div>{{ repository1.default_branch }}</div>
            </div>

            <div class="info-item">
              <div class="stat-name">Stargazers:</div>
              <div>{{ repository1.stargazers_count.toLocaleString() }}</div>
            </div>

            <div class="info-item">
              <div class="stat-name">Project Size:</div>
              <div>{{ repository1.size.toLocaleString() }} bytes</div>
            </div>
          </div>
      ...
      <div class="repository">
        <div class="rep-container">
          ...
          <h1>{{ repository2.owner }}/{{ repository2.name }}</h1>
          ...
          <div class="info-grid">
            <div class="info-item">
              <div class="stat-name">Forks Count:</div>
              <div>{{ repository2.forks_count.toLocaleString() }}</div>
            </div>

            <div class="info-item">
              <div class="stat-name">Forks:</div>
              <div>{{ repository2.forks.toLocaleString() }}</div>
            </div>

            <div class="info-item">
              <div class="stat-name">Watchers:</div>
              <div>{{ repository2.watchers_count.toLocaleString() }}</div>
            </div>

            <div class="info-item">
              <div class="stat-name">Issues:</div>
              <div>{{ repository2.open_issues_count.toLocaleString() }}</div>
            </div>

            <div class="info-item">
              <div class="stat-name">Tags:</div>
              <div>{{ (repository2.topics || []).join(", ") }}</div>
            </div>

            <div class="info-item">
              <div class="stat-name">Default Branch:</div>
              <div>{{ repository2.default_branch }}</div>
            </div>

            <div class="info-item">
              <div class="stat-name">Stargazers:</div>
              <div>{{ repository2.stargazers_count.toLocaleString() }}</div>
            </div>

            <div class="info-item">
              <div class="stat-name">Project Size:</div>
              <div>{{ repository2.size.toLocaleString() }} bytes</div>
            </div>
          </div>
...
export default {
  ...
  data() {
    return {
      ...
      repository2: {},
      fetchURL1:
        "https://scantist-backend.herokuapp.com/techstack/{name_owner}?name=react&owner=facebook",
      fetchURL2:
        "https://scantist-backend.herokuapp.com/techstack/{name_owner}?name=vue&owner=vuejs",
      option2: {
        tooltip: {
          trigger: "item",
        },
  ...
  methods: {
    ...
    async fetchData() {
      const repo1Fetch = await fetch(
        "https://cors-anywhere.herokuapp.com/" + this.fetchURL1,
        {
          method: "GET",
          headers: {
      ...
      const repo2Fetch = await fetch(
        "https://cors-anywhere.herokuapp.com/" + this.fetchURL2,
        {
          method: "GET",
          headers: {
            "content-type": "application/json",
